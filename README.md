...
[![GitHub release](https://img.shields.io/github/v/release/YOUR_USERNAME/MarginMind)](https://github.com/YOUR_USERNAME/MarginMind/releases)
...
1. 前往 [Releases](https://github.com/YOUR_USERNAME/MarginMind/releases) 页面
2. 下载最新版本的 `.xpi` 文件
3. 打开 Zotero → 工具 → 附加组件
...
```bash
# 克隆仓库
git clone https://github.com/YOUR_USERNAME/MarginMind.git
cd MarginMind
